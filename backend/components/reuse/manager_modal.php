...
if (isset($_GET['btn_search']) && ($_GET['btn_search']) > 0) {
  $search = $_GET['search'];
  $sql = "SELECT * FROM qlydonhang WHERE `ma_dh` like '$search' OR qlydonhang.`ma_kh` LIKE '%$search%'";
  $dsdh = $pdo->query($sql);
}
?>
  ...
  <div class="border mt-3">
    ...
    <div class="row">
      ...
      <div class="show-page" style="margin-left: 50px;">
        <form action="<?php echo $level . PAGES_PATH . 'admin-manager-recipt.php'; ?>" method="get">
      ...
      <tbody id="content-table">
        ...
        foreach ($dsdh as $dh) {
          echo '  <tr>
                ...
                <td><a href="../features/updateform.php?ma_dh=' . $dh['ma_dh'] . '">Sửa</a></td>
