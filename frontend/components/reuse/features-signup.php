                        ...
                        <div class="box-body">
                            <div class="feature-left">
                                <div class="feature-icon">
                                    <img src=<?php echo $level.IMG_PATH."feature_icon_1.png"?> alt="">
                                </div>
                            ...
                            <div class="feature-left">
                                <div class="feature-icon">
                                    <img src=<?php echo $level.IMG_PATH."feature_icon_2.png"?> alt="">
                                </div>
                                <div class="feature-content">
                            ...
                            <div class="feature-left">
                                <div class="feature-icon">
                                    <img src=<?php echo $level.IMG_PATH."feature_icon_3.png"?> alt="">
                                </div>
                                <div class="feature-content">
