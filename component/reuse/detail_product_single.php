                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                <ul id="demo1_thumbs" class="slideshow_thumbs">
                                    <li>
                                        <a href="https://www.xtmobile.vn/vnt_upload/product/10_2021/thumbs/600_iphone_13_256gb_xanh.jpg">
                                            <div class=" thumb-img"><img src="https://www.xtmobile.vn/vnt_upload/product/10_2021/thumbs/600_iphone_13_256gb_xanh.jpg" alt=""></div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://www.xtmobile.vn/vnt_upload/product/10_2021/thumbs/600_iphone_13_256gb_trang.jpg">
                                            <div class=" thumb-img"><img src="https://www.xtmobile.vn/vnt_upload/product/10_2021/thumbs/600_iphone_13_256gb_trang.jpg" alt=""></div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://www.xtmobile.vn/vnt_upload/product/10_2021/thumbs/600_iphone_13_256gb_hong.jpg" alt="">
                                            <div class=" thumb-img"><img src="https://www.xtmobile.vn/vnt_upload/product/10_2021/thumbs/600_iphone_13_256gb_hong.jpg" alt=""></div>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div id="slideshow"><img class="img-responsive animated fadeIn" src="https://www.xtmobile.vn/vnt_upload/product/10_2021/thumbs/600_iphone_13_256gb_xanh.jpg"></div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="product-single">
                                    ...
                                    <p class="product-price" style="font-size: 25px;">25.350.000đ<strike style="color:rgba(128, 128, 128, 0.658); font-size: 18px;">
                                            27.990.000đ</strike>
                                    </p>
                ...
                <div class="description-details">
                    <div class="description-left">
                        ...
                        <div itemprop="description" class="content_hide content-desc" style="height: 1180px;">
                            <h2><a href="https://www.xtmobile.vn/iphone-13-128gb" target="_blank"><span style="color: rgb(0, 0, 205);">iPhone 13 128GB</span></a>&nbsp;gây
                                ...
                                khiến người dùng không nên bỏ qua&nbsp;<a href="https://www.xtmobile.vn/iphone-13" target="_blank"><span style="color: rgb(0, 0, 205);">iPhone 13</span></a>&nbsp;series
                                trong năm nay.</h2>
                            ...
                            <p style="text-align: center;"><img alt="thiet-ke-iphone-13-128gb-xtmobile" src="https://www.xtmobile.vn/vnt_upload/product/10_2021/thiet-ke-iphone-13-128gb-xtmobile.jpg" style="width: 680px; height: 510px;"></p>
                            ...
                            <p style="text-align: center;"><img alt="Màn hình iPhone 13 128GB không có nhiều nâng cấp" src="https://www.xtmobile.vn/vnt_upload/product/10_2021/man-hinh-iphone-13-128gb-xtmobile.jpg" style="width: 680px; height: 510px;"></p>
                            ...
                            <p style="text-align: center;"><img alt="Sự xuất hiện của chip A15 Bionic chắc chắn sẽ mang đến hiệu năng cực kỳ tốt cho iPhone 13 128GB" src="https://www.xtmobile.vn/vnt_upload/product/10_2021/camera-iphone-13-128gb-xtmobile.jpg" style="width: 680px; height: 510px;"></p>
                                        ...
                                        <form class="review-right">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="name" type="text" class="form-control" placeholder="Họ tên" required="">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="textarea" name="textarea" rows="4" placeholder="Mời bạn nhập bình luận"></textarea>
                                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 mb30">
                        <div class="product-block">
                            <div class="product-img"><img src=<?php echo $level . IMG_PATH . "product_img_1.png" ?> alt=""></div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 mb30">
                        <div class="product-block">
                            <div class="product-img"><img src=<?php echo $level . IMG_PATH . "product_img_2.png" ?> alt=""></div>
                            <div class="product-content">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 mb30">
                        <div class="product-block">
                            <div class="product-img"><img src=<?php echo $level . IMG_PATH . "product_img_3.png" ?> alt=""></div>
                            <div class="product-content">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 mb30">
                        <div class="product-block">
                            <div class="product-img"><img src=<?php echo $level . IMG_PATH . "product_img_4.png" ?> alt=""></div>
                            <div class="product-content">
